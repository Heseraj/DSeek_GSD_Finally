...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/.gsd-surface.json`
(sibling to `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/skills`).
...
`C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/.gsd-surface.json`
Install profile marker: `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/.gsd-profile`
Skill dirs: `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/skills/gsd-*/`
Engine module: `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
