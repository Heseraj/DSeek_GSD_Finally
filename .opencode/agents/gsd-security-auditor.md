...
**Verification depth scales with `asvs_level`** (see @C:/Local_Folder_Learning/AI_Engineer/AI_Coder/DSeek_GSD_Finally/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
