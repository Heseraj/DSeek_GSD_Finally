...
- [x] **UI-01**: Single-page terminal-style layout with dark theme (watchlist, chart, portfolio, chat, header)
- [x] **UI-02**: Live price streaming with green/red flash animations and sparklines via `EventSource`
...
- [x] **UI-07**: Connection status indicator (green/yellow/red) and live portfolio value in the header
...
- [x] **DEPLOY-04**: Idempotent start/stop scripts (macOS/Linux shell + Windows PowerShell)

### Testing (TEST)

- [x] **TEST-01**: Playwright E2E infrastructure (`docker-compose.test.yml` + Playwright container, `LLM_MOCK=true`)
- [x] **TEST-02**: E2E scenarios cover fresh start, watchlist CRUD, buy/sell, visualizations, mocked AI chat, and SSE reconnection
